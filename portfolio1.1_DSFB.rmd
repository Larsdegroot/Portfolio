...
it's bright and unreadable colors, data is in wide/tidy format and many columns have the same value on each cell of the column.
...
all value's are now a measure depended on the control negative. this is useful because now all measures are on the same scale.
(i dont fully understand this, ask teacher)
