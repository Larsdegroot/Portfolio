...
- Nederlands <i class="fas fa-square"></i> <i class="fas fa-square"></i> <i class="fas fa-square"></i> <i class="fas fa-square"></i> <i class="fas fa-square"></i>
- Engels <i class="fas fa-square"></i> <i class="fas fa-square"></i> <i class="fas fa-square"></i> <i class="fas fa-square"></i> <i class="far fa-square"></i>
...
Een gedreven student met een passie voor biologie en technologie. Mijn interesses liggen bij genetica, moleculaire biologie, programmeren en planten. Als hobby kweek ik zeldzame planten in een zelfgemaakte kas. 
