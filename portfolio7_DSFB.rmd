...
First of all i there is no description what `influenza activity` actually is. I assume because its only positive integers that it means individuals infected. So i want to see if population has a correlation with `influenza activity`.
